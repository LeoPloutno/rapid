    ...
    U: GroupDecoupledPhysicalPotential<T, V> + ?Sized,
{
    ...
    fn set_forces(
        ...
        let positions = groups_positions
            ...
            .expect("`span` should be a valid range in `groups_positions`");
        #[allow(deprecated)]
        GroupDecoupledPhysicalPotential::set_forces(self, group, positions, group_forces);
    }
    ...
    fn add_forces(
        ...
        let positions = groups_positions
            ...
            .expect("`span` should be a valid range in `groups_positions`");
        #[allow(deprecated)]
        GroupDecoupledPhysicalPotential::add_forces(self, group, positions, group_forces);
    }
}
...
pub use self::{
    ...
    group_decoupled::MonteCarloGroupDecoupledPhysicalPotential,
